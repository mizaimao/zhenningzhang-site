...
description: "A self-hosted ML platform — local LLM serving, retrieval, agents, and multimodal generation — running on a multi-host Proxmox cluster with GPU passthrough. No third-party inference APIs."
date: 2026-06-01
...
serving, retrieval, agents, and multimodal generation, with no dependency
...
This is the same infrastructure discipline I bring to Ditali, my team's
ML platform at AstraZeneca — model serving, data flow, and service
orchestration — applied to a system I own end to end.

## How it's built

- **Multi-host Proxmox cluster** — ML services run as VMs and containers
