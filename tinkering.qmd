...
multimodal generation — running on a multi-host Proxmox cluster with GPU
passthrough across CUDA and ROCm. Local inference is the default path;
provider-pluggable for Anthropic, Google, and others.
